...
namespace Aga.Controls.Tree
{
	public class TreeList: ListView
	{
        ...
        public static readonly DependencyProperty ModelProperty =
                        ...
                        new FrameworkPropertyMetadata(null, (o, e) => { ((TreeList)o).onModelChanged((ITreeModel)e.NewValue); }));

        public ITreeModel Model { get { return (ITreeModel)GetValue(ModelProperty); } set { SetValue(ModelProperty, value); } }
        ...
        private void onModelChanged(ITreeModel treeModel)
        {
