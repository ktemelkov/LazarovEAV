...
namespace LazarovEAV.ViewModel
{
    ...
    class MainViewModel : NotifyPropertyChangedImpl, IDisposable
    {
        ...
        public MainViewModel(Window wnd)
        {
            ...
            this.eavDevice = new EavDeviceViewModel(this.protocolAdapter = new ProtocolAdapter(this.deviceManager = new EavDeviceManager()));
        ...
        private void onConnect(bool fSuccess)
        {
            if (fSuccess)
            {
                printLog("Connected.");
        ...
        {
            this.protocolAdapter.feedData(data);
//            printLog(data);
        }
